...
bild_normal = ladeBild('10_ms_cell_normal.gif')
bild_markiert = ladeBild('10_ms_cell_marked.gif')
bild_mine = ladeBild('10_ms_cell_mine.gif')
bild_aufgedeckt = []
for n in range(9):
  bild_aufgedeckt.append(ladeBild(f'10_ms_cell_{n}.gif'))
  ...
  for event in pg.event.get():
    ...
    if event.type == pg.MOUSEBUTTONDOWN:
      ...
      if pg.mouse.get_pressed()[0]:
        cell.aufgedeckt = True
        #rekursive Vorgehensweise durch floodfill
